      ...
      <form @submit.prevent="handleSaveSettings" class="space-y-6">
        ...
        <div class="space-y-3 pt-4" style="border-top: 1px solid var(--surface-border);">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div>
              <label class="block text-xs font-semibold mb-1.5 uppercase tracking-wider" style="color: var(--surface-muted);">Line Orientation</label>
              <select v-model="form.line_orientation" class="input" :disabled="!isAdmin">
                <option value="horizontal">Horizontal (Atas/Bawah)</option>
                <option value="vertical">Vertical (Kiri/Kanan)</option>
              </select>
            </div>
            <div>
